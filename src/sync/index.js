...
const Topic = require('../models/old/topic');
const CentralizedOracle = require('../models/old/centralized-oracle');
const DecentralizedOracle = require('../models/old/decentralized-oracle');
const Vote = require('../models/old/vote');
const OracleResultSet = require('../models/old/oracle-result-set');
const FinalResultSet = require('../models/old/final-result-set');
const Withdraw = require('../models/old/withdraw');
